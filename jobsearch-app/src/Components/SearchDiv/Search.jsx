    ...
    <div className='searchDiv grid gp-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      <form action="">
        ...
        <div className="flex gap-2 items-center">
          ...
          focus:outline-none w-[100%]' placeholder='Procure emprego aqui...'/>
        ...
        <div className="flex gap-2 items-center">
          ...
          <input type="text" className='bg-transparent text-blue-500
          focus:outline-none w-[100%]' placeholder='Pesquise por empresa...'/>
            <AiOutlineCloseCircle className='text-[30px] text-[#a5a6a6]
            hover:text-textColor icon'/>
        </div>
        ...
        <div className="flex gap-2 items-center">
          ...
          <input type="text" className='bg-transparent text-blue-500
          focus:outline-none w-[100%]' placeholder='Pesquise por localização...'/>
            <AiOutlineCloseCircle className='text-[30px] text-[#a5a6a6]
            hover:text-textColor icon'/>
        </div>

        <button className='bg-blueColor h-full p-5 px-10 rounded-[10px] text-white cursor-pointer hover:bg-blue-300'>Procurar</button>
